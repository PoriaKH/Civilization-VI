...
public class PlayGameMenuController {
    ...
    public String[] showMap(String ANSI_COLORS[], String number[], String types[], String unit1[], String unit2[], String cv[]){
        ...
        map[20] = ANSI_COLORS[1] + block7 + "   " +  ANSI_COLORS[12] + block7 + ANSI_COLORS[72] + block + block + block + block + block + block + block + ANSI_RESET + ANSI_COLORS[23] + "\\" + block + block + block + block + block + block + "/" + "   " + ANSI_COLORS[34] + block7 + "   " + ANSI_COLORS[45] + block7 + "   " + ANSI_COLORS[56] + block7 + "   " + ANSI_COLORS[67] + block7 + ANSI_RESET;
